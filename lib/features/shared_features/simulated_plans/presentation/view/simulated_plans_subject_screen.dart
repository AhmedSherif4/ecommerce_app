...
class _ChildSubjectScreenForSimulated extends StatelessWidget {
  ...
  //               OrientationItem(
  //                   portraitWidget: _SimulatedSubjectPortraitView(simulatedPlans: simulatedSubjectData.simulatedPlans,childId: simulatedSubjectData.childId,),
  //                   landscapeWidget: _SimulatedSubjectLandscapeView(simulatedPlans: simulatedSubjectData.simulatedPlans,childId: simulatedSubjectData.childId,)),],
  ...
  //       ),
  //       AppSize.s10.sizedBoxHeight,
  //       if(!simulatedSubjectData.simulatedPlans.isSubscribed  && simulatedSubjectData.simulatedPlans.examsData.isNotEmpty)
...
class _SimulatedSubjectPortraitView extends StatelessWidget {
  ...
  //       return CustomInkWell(
  //         onTap: () {
  //           if(simulatedPlans.isSubscribed){
  //             RouteManager.rPushNamed(
  //                 context: context,
  //                 rName: AppRoutesNames.rSimulatedeExamsScreen,
  //                 arguments:SimulatedSubjectData(
  //                   simulatedPlans: simulatedPlans,
  //                   index: index,
  //                   childId: childId,
  //                   playDuration: false,
  //                 )
