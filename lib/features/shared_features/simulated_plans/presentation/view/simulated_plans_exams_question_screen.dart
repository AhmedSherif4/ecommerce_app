...
class SimulatedQuestionScreen extends StatefulWidget {
  ...
  @override
  State<SimulatedQuestionScreen> createState() =>
      _SimulatedQuestionScreenState();
}
...
class _SimulatedQuestionScreenState extends State<SimulatedQuestionScreen> {
  ...
  String convertTimer(var duration) {
    ...
    return '${convertToArabicNumerals(minutes)}:${convertToArabicNumerals(seconds)}';
  }

  @override
  void dispose() {
    _timer?.cancel();
    ScreenProtectorService.instance.disableScreenProtection();
    super.dispose();
  }
  ...
  //                     itemCount: widget
  //                         .simulatedSubjectData.simulatedQuestionEntity!.length,
  ...
  //                                 SimulatedExamQuestionsAnswersInputs(
  //                                     childId:
  //                                         widget.simulatedSubjectData.childId,
  //                                     examId: widget
  //                                         .simulatedSubjectData
  ...
  //                             children: [
  //                               if (widget
  //                                   .simulatedSubjectData.playDuration) ...[
  //                                 Container(
  ...
  //                                               questionIndex],
  //                                         ),
  //                                         if (!widget.simulatedSubjectData
  //                                             .playDuration) ...[
  //                                           AppSize.s10.sizedBoxWidth,
